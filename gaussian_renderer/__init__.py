...
def render_imp(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, image_shape=None, scaling_modifier = 1.0, override_color = None, flag_max_count=True, culling=None):
    """
    Render the scene. 
